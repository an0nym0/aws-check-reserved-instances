...
parser.add_argument('-r', '--recipients', help='List of emails for send notifications. '
                                               'Space separated. By default - notifications@domain.com',
                    nargs='+', dest='recipients', required=False, default=['test@domain.com'])
...
def describe_regions():
    sts_ak, sts_sak, sts_sk = get_tmp_cred("<ACCOUNT_ID>")
